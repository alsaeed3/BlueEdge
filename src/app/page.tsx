...
export default function App() {
      ...
      if (!isSessionStarted) {
        ...
        pc.ontrack = (e) => {
          if (audioElement.current) {
            ...
            // Setup audio analyzer to detect AI speaking
  ...
  const analyzeAudio = () => {
    if (audioAnalyserRef.current) {
      ...
      // Normalize to 0-1 range for the WaveAvatar component
      const normalizedLevel = Math.min(average / 128, 1);
      setAudioLevel(normalizedLevel);

      // Set speaking state based on audio threshold
      setIsAISpeaking(normalizedLevel > 0.05);
