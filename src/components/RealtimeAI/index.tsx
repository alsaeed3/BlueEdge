...
export default function RealtimeAI() {
  ...
  return (
    <div className="flex justify-center items-start min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4 sm:p-8">
      <Card className="w-full max-w-2xl mx-auto shadow-2xl border-primary/30 bg-card overflow-hidden rounded-xl">
        <CardHeader className="text-center p-6 sm:p-8 border-b border-border/50 bg-muted/30">
        ...
        <CardContent className="p-6 sm:p-8">
          ...
          <div className="mt-8"> {/* Wrapper for AudioPlayer */}
        ...
        <CardFooter className="p-6 bg-muted/20 border-t border-border/50">
          <div className="debug-info w-full text-xs font-mono text-muted-foreground/80 
                          p-4 border border-dashed border-border/30 rounded-lg bg-background/50">
